...
import { LogOut, Settings, Sprout, Building2, Truck, Landmark } from 'lucide-react';
...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <aside className="w-64 bg-slate-900 text-slate-300 p-4 flex flex-col justify-between shrink-0 min-h-screen border-r border-slate-800">
      <div>
        {/* Brand Header */}
        ...
        <ul className="space-y-1 text-xs">
          ...
          {currentRole === 'admin' && (
            <li
              onClick={() => openModal('agritexOfficerModal')}
